...
% Taken from: https://www.mathworks.com/matlabcentral/fileexchange/32644-loadminc?fbclid=IwAR1mN_eC6RbZxBFwfQnxkdQFnOtuifIjZAuGAeRURMKVnUZvR_ni0SfXlRw
% Use for loading minc files on Windows computer.
%
%function [imaVOL,scaninfo] = loadminc(filename)
%
...
if length(slice_min) >1 % ha minden slice-hoz el van t�rolva a max-min �rt�k 
