classdef Violin < handle
    ...
    methods
        function obj = Violin(data, pos, varargin)
            ...
            if numel(data) == 1
                obj.MedianPlot = scatter(pos, data, 'filled');  % C.R. added marker size
            ...
            obj.MedianPlot = scatter(pos, quartiles(2), 50, [1 1 1], 'filled'); % C.R. marker size was [];
        ...
        function set.ViolinAlpha(obj, alpha)
            ...
            obj.ScatterPlot.MarkerFaceAlpha = 0.8; % C.R. adjust
    ...
    methods (Access=private)
        function results = checkInputs(obj, data, pos, varargin)
            ...
            p.addParameter('BoxColor', [0.3 0.3 0.3], iscolor); %C.R. was 0.5 0.5 0.5
            ...
            isscalarlogical = @(x) (islogical(x) | isscalar(x)); % C.R. changed from & to |
