function [ T1corr, MP2RAGEcorrected, M0map_corr] = CR_T1B1correctpackageTFL_withM0( B1img, MP2RAGEimg, MP2RAGEINV2nii, MP2RAGE, brain, InvEff)
...
if max(MP2RAGEimg.img,[],'all') > 2000
    MP2RAGEimg.img = double(MP2RAGEimg.img)/4095-0.5;
end
%% now the fun starts
...
try
    ...
    MP2RAGEcorrected = 0;
    disp('MP2RAGE corrected image generation failed');
end
