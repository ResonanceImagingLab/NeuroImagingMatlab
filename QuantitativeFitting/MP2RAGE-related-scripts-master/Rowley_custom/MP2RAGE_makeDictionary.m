function [T1, PD, R1] = MP2RAGE_makeDictionary(MP2RAGE, INV1,INV2,B1map,varargin)

% Based on MP2RAGE_dictionaryMatching, but separate into two steps
% Making the dictionary takes too long, especially when it needs to be
% recomputed many times.
% Christopher Rowley 2025
